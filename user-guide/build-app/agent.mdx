...
![Explore-Agent Assistant Application Template](../../../assets/docs-1.png)
...
![Selecting the Reasoning Model for Agent Assistant](../../../assets/docs-3.png)
...
![Orchestrating Prompts for Agent Assistant](../../../assets/docs-4.png)
...
![Adding Tools for the Assistant](../../../assets/docs-5.png)
...
![Function Calling Mode](../../../assets/docs-6.png)

![ReAct Mode](../../../assets/guides/application_orchestrate/agent/sec-7.png)
...
![Configuring the Conversation Opener and Initial Questions](../../../assets/docs-8.png)
...
![Debugging and Preview](../../../assets/docs-9.png)

## Application Publish

![Publishing the Application as a Webapp](../../../assets/docs-10.png)