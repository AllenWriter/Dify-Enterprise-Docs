...
<Frame caption="APIに基づいた拡張">
  <img src="/user-guide/.gitbook/assets/api_based_01.png" alt="APIに基づいた拡張" />
</Frame>
...
<Frame caption="ダウンロード">
  <img src="../../../.gitbook/assets/download.png" alt="Download" />
</Frame>
...
<Frame caption="ポート確認">
  <img src="/user-guide/.gitbook/assets/8000.png" alt="ポート確認" />
</Frame>
...
<Frame caption="Ngrok 起動">
  <img src="/user-guide/.gitbook/assets/ngrock.png" alt="Ngrok 起動" />
</Frame>
...
詳細については、[Cloudflare Workersを使用したAPI Toolsのデプロイ](/user-guide/tools/extensions/api-based/cloudflare-workers) をご参照ください。
