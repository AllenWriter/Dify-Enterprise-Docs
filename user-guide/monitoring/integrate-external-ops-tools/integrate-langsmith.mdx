...
![](https://r2.xmsex.net/2024/10/549b068ee0ad538468962c24cbd75a12.png)

创建完成之后在 Projects 内可以查看该项目。

![](https://r2.xmsex.net/2024/10/3933bf233a53ecfd9d65277ca75d7498.png)

#### 3. 创建项目凭据

创建项目凭据，在左侧边栏内找到项目设置 **Settings**。

![](https://r2.xmsex.net/2024/10/b39a93efd9ad6b7c96d3b6570ddddd31.png)

点击 **Create API Key**，创建一个项目凭据。

![](https://r2.xmsex.net/2024/10/ebc11086d8271e6fc4fca8932f39a5f6.png)

选择 **Personal Access Token** ，用于后续的 API 身份校验。

![](https://r2.xmsex.net/2024/10/64fcf9fa5e5cfdd14c646ca642ccfc7b.png)

将创建的 API key 复制保存。

![](https://r2.xmsex.net/2024/10/6fdd64d6a0b65bd60ce615b890381382.png)

#### 4. 将 LangSmith 集成至 Dify 平台

在 Dify 应用内配置 LangSmith。打开需要监测的应用，在左侧边菜单内打开**监测**，点击页面内的**配置。**

![](https://r2.xmsex.net/2024/10/e653423642e9a4737b0c2be339cde088.png)

点击配置后，将在 LangSmith 内创建的 **API Key** 和**项目名**粘贴到配置内并保存。

![](https://r2.xmsex.net/2024/10/97e2095644b1cbd1adcdc518d6b2b3a4.png)
...
![](https://r2.xmsex.net/2024/10/9f0b5d10e825686e5a86b70c69bb5a17.png)

### 在 LangSmith 内查看监测数据

配置完成后， Dify 内应用的调试或生产数据可以在 LangSmith 查看监测数据。

![](https://r2.xmsex.net/2024/10/823d5cfd3844698f83492fb6e9657a93.png)

![](https://r2.xmsex.net/2024/10/81fbb3266749a6727fcc59a46b22695b.png)

![](https://r2.xmsex.net/2024/10/67c8368070c5b577e2ae53142829ca30.png)
