...
<Frame caption="知识库问答应用示例">
  <img src="/user-guide/.gitbook/assets/image (244).png" alt="知识库问答应用示例" />
</Frame>
...
<Frame caption="知识检索配置">
  <img src="/user-guide/.gitbook/assets/image (74).png" alt="知识检索配置" />
</Frame>

**输出变量**

<Frame caption="输出变量">
  <img src="/user-guide/.gitbook/assets/image (250).png" alt="输出变量" width="272" />
</Frame>
...
<Frame caption="配置下游 LLM 节点">
  <img src="/user-guide/.gitbook/assets/image (77).png" alt="配置下游 LLM 节点" />
</Frame>
