...
- Redis Database
    - Version 6+
    - 1 GB RAM
- [Vector DB Virtual Machine - Qdrant Single Node](/en-us/deployment/advanced-configuration/qdrant/single-node)
    - 1 Virtual Machines
    - 4 CPU, 8 GB RAM
    - 100 GB Storage
...
Update the <a href="https://assets-docs.dify.ai/2024/12/e6901d10e4cc3211347c93ab4c730bc2.yaml" download="values-no-infra-for-testing.yaml">values-no-infra-for-testing.yaml</a> file.
