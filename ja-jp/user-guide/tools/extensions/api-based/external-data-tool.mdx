...
AIアプリを作成する際、開発者はAPI拡張を通じて外部ツールを利用し、追加データを取得してPromptに組み込むことができます。具体的な手順については[API拡張](/user-guide/tools/extensions/api-based/api-based-extension)を参照してください。

### 前提条件

まずは[API拡張](/user-guide/tools/extensions/api-based/api-based-extension)を読み、APIサービスの基本的な機能の開発と接続を完了してください。
