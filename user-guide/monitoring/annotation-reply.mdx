...
<Frame caption="标注回复流程">
  <img src="user-guide/.gitbook/assets/image (181).png" alt="标注回复流程" width="563" />
</Frame>
...
<Frame caption="提示词编排中开启标注回复">
  <img src="user-guide/.gitbook/assets/image (124).png" alt="提示词编排中开启标注回复" />
</Frame>
...
<Frame caption="标注回复参数设置">
  <img src="user-guide/.gitbook/assets/image (126).png" alt="标注回复参数设置" />
</Frame>
...
<Frame caption="添加标注回复">
  <img src="user-guide/.gitbook/assets/image (128).png" alt="添加标注回复" />
</Frame>

编辑成你需要的高质量回复并保存。

<Frame caption="编辑标注回复">
  <img src="user-guide/.gitbook/assets/image (129).png" alt="编辑标注回复" />
</Frame>

再次输入同样的用户问题，系统将使用已保存的标注直接回复用户问题。

<Frame caption="通过已保存的标注回复用户问题">
  <img src="user-guide/.gitbook/assets/image (130).png" alt="通过已保存的标注回复用户问题" />
</Frame>
...
<Frame caption="日志与标注中开启标注回复">
  <img src="user-guide/.gitbook/assets/image (118).png" alt="日志与标注中开启标注回复" />
</Frame>
...
<Frame caption="设置标注回复参数">
  <img src="user-guide/.gitbook/assets/image (119).png" alt="设置标注回复参数" />
</Frame>
...
<Frame caption="批量导入标注问答对">
  <img src="user-guide/.gitbook/assets/image (120).png" alt="批量导入标注问答对" />
</Frame>
...
<Frame caption="批量导出标注问答对">
  <img src="user-guide/.gitbook/assets/image (121).png" alt="批量导出标注问答对" />
</Frame>
...
<Frame caption="查看标注回复命中历史">
  <img src="user-guide/.gitbook/assets/image (123).png" alt="查看标注回复命中历史" />
</Frame>
