...
Depending on the SSO scope you intend to enable, **the Callback URL may vary**. The system administrator needs to paste the Dify Enterprise Callback URL into the corresponding Okta OAuth2 application to finalize the setup.
...
## 3. Complete the Configuration in Dify
...
2. Switch to the **Sign On** tab and locate the **Issuer** field. Change the **Issuer URL** to a fixed link.
...
Obtain the following details from your OAuth application:
