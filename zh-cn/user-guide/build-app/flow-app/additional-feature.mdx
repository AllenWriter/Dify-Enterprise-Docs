...
<Frame caption="开启视觉分析能力">
  <img src="/user-guide/.gitbook/assets/image (7).png" alt="LLM节点中开启视觉分析能力的设置界面" />
</Frame>
...
*   **文件上传**
    ...
    <Frame caption="文件上传功能">
      <img src="/user-guide/.gitbook/assets/image (8).png" alt="Chatflow应用中文件上传功能的设置界面" />
    </Frame>
...
<Frame caption="使用文件上传">
  <img src="/user-guide/.gitbook/assets/image (9).png" alt="Chatflow应用中使用文件上传功能的界面" />
</Frame>
...
<Frame caption="文档文件编排">
  <img src="/user-guide/.gitbook/assets/image (372).png" alt="处理文档文件的工作流编排示意图" />
</Frame>
...
<Frame caption="开启视觉分析能力">
  <img src="/user-guide/.gitbook/assets/image (3) (2).png" alt="LLM节点中开启视觉分析能力的设置界面" />
</Frame>
...
<Frame caption="混合文件处理">
  <img src="/user-guide/.gitbook/assets/image (16).png" alt="处理混合文件类型的工作流编排示意图" />
</Frame>
