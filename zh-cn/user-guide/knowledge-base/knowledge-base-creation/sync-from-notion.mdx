...
<Frame caption="绑定 Notion">
  <img src="https://r2.xmsex.net/2024/10/56dc0cac00f2da808378c82c1791b30a.png" alt="" />
</Frame>
...
<Frame caption="同步 Notion 内容">
  <img src="user-guide/.gitbook/assets/sync-notion.png" alt="" />
</Frame>
...
<Frame caption="">
  <img src="user-guide/.gitbook/assets/image (137).png" alt="" />
</Frame>

创建集成后，您可以根据需要在 Capabilities 选项卡下更新其设置，并在 Secrets 下点击 “Show” 按钮然后复制 Secrets。

<Frame>
  <img src="user-guide/.gitbook/assets/image (138).png" alt="" />
</Frame>
...
<Frame caption="">
  <img src="user-guide/.gitbook/assets/image (139).png" alt="" />
</Frame>

在集成的设置页面中成功公开集成后，您将能够在密钥选项卡中访问集成的密钥：

<Frame caption="">
  <img src="user-guide/.gitbook/assets/image (140).png" alt="" />
</Frame>
