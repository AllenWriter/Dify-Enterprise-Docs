---
title: Enterprise User Authentication
---

Enterprise users are team members who have registered in the Dify Enterprise workspace or been added by administrators through the admin console. Our authentication system ensures these users can only access Dify Enterprise resources after proper verification.
