...
**Solution**: Please refer to [Azure - Advanced Configuration: Edit Attributes and Claims](/en-us/administrator-guide/sso/azure/saml#advanced-configuration-edit-attributes-and-claims), and change the **source attribute** for the **Unique User Identifier (Name ID)** to `user.mail`.
