...
![](https://r2.xmsex.net/2024/10/34ca6a973c4a1230be659b313b99fd90.png)

为项目编辑一个名称。

![](https://r2.xmsex.net/2024/10/15573fe632c574242bb5b648a5b38748.png)

3. 创建项目 API 凭据，在项目内左侧边栏中点击 **Settings** 打开设置

![](https://r2.xmsex.net/2024/10/1bea702aa7d0fd5c99fddf8aca901911.png)

在 Settings 内点击 **Create API Keys** 创建一个项目 API 凭据。

![](https://r2.xmsex.net/2024/10/391f7536e8749a7044f7c6450d37e906.png)

复制并保存 **Secret Key** ，**Public Key，Host**

![](https://r2.xmsex.net/2024/10/68b7a1ea407c4cec782137921cfe711c.png)

4. 在 Dify 内配置 Langfuse，打开需要监测的应用，在侧边菜单打开**监测**，在页面中选择**配置。**

![](https://r2.xmsex.net/2024/10/e0e52a8e2897d1a348bd4d62dd3d0732.png)

点击配置后，将在 Langfuse 内创建的 **Secret Key, Public Key, Host** 粘贴到配置内并保存。

![](https://r2.xmsex.net/2024/10/98d69f97ec329ea593bbd3e881ac0406.png)

成功保存后可以在当前页面查看到状态，显示已启动即正在监测。

![](https://r2.xmsex.net/2024/10/3afd6f260ece2f80a7e3dec6508cf7d3.png)
...
![](https://r2.xmsex.net/2024/10/cbade2f1c4da8c89644475d5fbdfa031.png)

![](https://r2.xmsex.net/2024/10/ed3a3bcfd434763a80f9234a7baf16b1.png)

![](https://r2.xmsex.net/2024/10/2dfded4b6ffb2a7d163d71f871b53018.png)
