...
Access the enterprise admin dashboard, click "2-Step Verification" → "Disable Two-Step Verification."

### Enterprise Global Setting

Access the enterprise admin dashboard, click **"Settings" → "Authentication"** and turn off the two-step verification toggle.
