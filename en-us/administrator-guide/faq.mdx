...
**Solution**: Please refer to [Authentication - User Account Creation Methods](/en-us/administrator-guide/authentication#user-account-creation-methods-in-enterprise-edition) and enable the following two account creation methods:
