...
![Creating Knowledge Base](../../images/assets/create-knowledge-base-2.png)
...
![Automatic mode](../../images/assets/image (93).png)
{% endtab %}
...
![Custom mode](../../images/assets/image (95).png)
{% endtab %}
{% endtabs %}
...
![High Quality](../../images/assets/image (96).png)
{% endtab %}
...
![Economical mode](../../images/assets/image (97).png)
{% endtab %}
...
![Texts summarized into multiple Q&#x26;A pairs in Q&#x26;A segment mode](../../images/assets/Q&#x26;A-pair.png)

![Difference between Q to P and Q to Q indexing modes](../../images/assets/q2p-and-q2q.png)
{% endtab %}
{% endtabs %}
...
![Vector Search Settings](../../images/assets/image (99).png)
...
![Full-Text Search Settings](../../images/assets/full-text-search.png)
...
![Hybrid Retrieval Setting](../../images/assets/hybrid-search (1).png)
...
![Inverted Index](../../images/assets/image (100).png)
