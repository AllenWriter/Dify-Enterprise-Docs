...
<Frame title="召回模式设置">
  <img src="/user-guide/.gitbook/assets/zh-rag-multiple.png" alt="" />
</Frame>
...
在多路召回模式下，建议配置 Rerank 模型。你可以阅读 [重排序](/user-guide/knowledge-base/indexing-and-retrieval/rerank) 了解更多。

以下是多路召回模式的技术流程图：

<Frame title="多路召回">
  <img src="/user-guide/.gitbook/assets/image (134).png" alt="" />
</Frame>
