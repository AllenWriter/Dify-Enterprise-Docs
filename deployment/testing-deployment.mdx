...
- Redis Database
    - Version 6+
    - 1 GB RAM
- [Vector DB Virtual Machine - Qdrant Single Node](../configuration/qdrant/single-node.md)
    - 1 Virtual Machines
    - 4 CPU, 8 GB RAM
    - 100 GB Storage
...
- [How to install Dify Enterprise](../quick-start/kubernetes.md)

### Verify Services Status
After the installation, you can verify the services status referring to the following guide.
- [How to verify Dify Enterprise services status](./verify-services-status.md)