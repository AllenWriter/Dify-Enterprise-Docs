...
You can manually add or modify the variable as shown in the example below. For instance, to add `ENV_FROM_COMMUNITY1` and `ENV_FROM_COMMUNITY2` to the `values.yaml` file:
