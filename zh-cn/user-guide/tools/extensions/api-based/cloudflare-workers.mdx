...
<Frame caption="在 Dify 中添加 API Endpoin">
  <img src="/user-guide/.gitbook/assets/api_extension_edit.png" alt="在 Dify 中添加 API Endpoin" />
</Frame>

<Frame caption="在 App 编辑页面中添加上 API Tool">
  <img src="/user-guide/.gitbook/assets/app_tools_edit.png" alt="在 App 编辑页面中添加上 API Tool" />
</Frame>
