...
![](user-guide/.gitbook/assets/zh-tools-perplexity.png)
...
![](user-guide/.gitbook/assets/zh-tools-chatflow-perplexity.png)

* **Agent 应用**

在 Agent 应用内添加 `Perplexity Search` 工具，然后输入相关指令即可调用此工具。

![](user-guide/.gitbook/assets/zh-tools-agent-perplexity.png)
