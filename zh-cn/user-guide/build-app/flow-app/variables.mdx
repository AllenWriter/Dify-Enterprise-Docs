...
![](/img/c405efa31fd5708542fdc3bd7c0cb708.png)
...
![](/img/e387366fe2643688d57e6b9a69eacb1b.png)

### 环境变量

**环境变量用于保护工作流内所涉及的敏感信息**，例如运行工作流时所涉及的 API 密钥、数据库密码等。它们被存储在工作流程中，而不是代码中，以便在不同环境中共享。

![](/img/d27ebecdc87e630212fb0ed866bf8e9e.png)
...
![](/img/338f93f401142fea4936a67a615eba32.png)
