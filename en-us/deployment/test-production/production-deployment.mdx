...
Update the <a href="https://assets-docs.dify.ai/2024/12/dd700c1e389951f5164ad884aa127ee2.yaml" download="values-no-infra-for-prod.yaml">values-no-infra-for-prod.yaml</a> file.
