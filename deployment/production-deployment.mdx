...
- Redis Database
    - Version 6+
    - 2 GB RAM
- [Vector DB Virtual Machine - Qdrant Cluster](/deployment/advanced-configuration/qdrant/qdrant-cluster)
    - 3 Virtual Machines
    - 8 CPU, 64 GB RAM
    - 100 GB Storage
...
### Update Helm Chart Values `values-no-infra-for-prod.yaml`
