...
![Create a project in LangSmith](../../../images/assets/image (3) (1) (1) (1).png)

Once created, you can view all created projects in the Projects section.

![View created projects in LangSmith](../../../images/assets/image (7) (1) (2).png)

#### 3. Create Project Credentials

Find the project settings **Settings** in the left sidebar.

![Project settings](../../../images/assets/image (8) (1) (2).png)

Click **Create API Key** to create project credentials.

![Create a project API Key](../../../images/assets/image (3) (1) (1) (1) (2).png)

Select **Personal Access Token** for subsequent API authentication.

![Create an API Key](../../../images/assets/image (5) (1) (1) (1).png)

Copy and save the created API key.

![Copy API Key](../../../images/assets/image (9) (2).png)
...
![Tracing app performance](../../../images/assets/tracing-app-performance.png)

After clicking configure, paste the **API Key** and **project name** created in LangSmith into the configuration and save.

![Configure LangSmith](../../../images/assets/config-langsmith.png)
...
![View configuration status](../../../images/assets/integrate-with-langsmith.png)
...
![Debugging Applications in Dify](../../../images/assets/debug-app-in-dify.png)

When you switch to LangSmith, you can view detailed operation logs of Dify applications in the dashboard.

![Viewing application data in LangSmith](../../../images/assets/image (2) (1) (1) (1).png)

Detailed LLM operation logs through LangSmith will help you optimize the performance of your Dify application.

![Viewing application data in LangSmith](../../../images/assets/viewing-app-data-in-langsmith.png)
