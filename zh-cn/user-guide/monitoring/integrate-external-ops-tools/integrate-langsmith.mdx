...
<Frame caption="在 LangSmith 内创建项目">
  <img src="/user-guide/.gitbook/assets/image (29).png" alt="LangSmith 创建项目界面" />
</Frame>

创建完成之后在 Projects 内可以查看该项目。

<Frame caption="在 LangSmith 内查看已创建项目">
  <img src="/user-guide/.gitbook/assets/image (36).png" alt="LangSmith 项目列表界面" />
</Frame>
...
<Frame caption="项目设置">
  <img src="/user-guide/.gitbook/assets/image (37).png" alt="LangSmith 项目设置界面" />
</Frame>

点击 **Create API Key**，创建一个项目凭据。

<Frame caption="创建一个项目 API Key">
  <img src="/user-guide/.gitbook/assets/image (32).png" alt="LangSmith 创建 API Key 界面" />
</Frame>

选择 **Personal Access Token** ，用于后续的 API 身份校验。

<Frame caption="创建一个 API Key">
  <img src="/user-guide/.gitbook/assets/image (34).png" alt="LangSmith 选择 API Key 类型界面" />
</Frame>

将创建的 API key 复制保存。

<Frame caption="复制 API Key">
  <img src="/user-guide/.gitbook/assets/image (38).png" alt="LangSmith API Key 复制界面" />
</Frame>
...
<Frame caption="配置 LangSmith">
  <img src="/user-guide/.gitbook/assets/image (40).png" alt="Dify 配置 LangSmith 入口界面" />
</Frame>

点击配置后，将在 LangSmith 内创建的 **API Key** 和**项目名**粘贴到配置内并保存。

<Frame caption="配置 LangSmith">
  <img src="/user-guide/.gitbook/assets/image (41).png" alt="Dify 配置 LangSmith 详情界面" />
</Frame>
...
<Frame caption="查看配置状态">
  <img src="/user-guide/.gitbook/assets/image (44).png" alt="Dify LangSmith 配置状态界面" />
</Frame>
...
<Frame caption="在 Dify 内调试应用">
  <img src="/user-guide/.gitbook/assets/image (46).png" alt="Dify 应用调试界面" />
</Frame>

<Frame caption="在 LangSmith 内查看应用数据">
  <img src="/user-guide/.gitbook/assets/image (28).png" alt="LangSmith 应用数据监测界面1" />
</Frame>

<Frame caption="在 LangSmith 内查看应用数据">
  <img src="/user-guide/.gitbook/assets/image (47).png" alt="LangSmith 应用数据监测界面2" />
</Frame>
