...
<Frame>
  <img src="/images/assets/image-(130).png" alt="Annotated Replies Workflow" width="563" />
</Frame>
...
<Frame>
  <img src="/images/assets/annotated-replies.png" alt="Enabling Annotated Replies in Prompt Orchestration" />
</Frame>
...
<Frame>
  <img src="/images/assets/setting-parameters-for-annotated-replies.png" alt="Setting Parameters for Annotated Replies" />
</Frame>
...
<Frame>
  <img src="/images/assets/add-annotation-reply.png" alt="Adding Annotated Replies" />
</Frame>

Edit the response to the high-quality reply you need and save it.

<Frame>
  <img src="/images/assets/editing-annotated-replies.png" alt="Editing Annotated Replies" />
</Frame>

Re-enter the same user question, and the system will use the saved annotation to reply to the user's question directly.

<Frame>
  <img src="/images/assets/annotaiton-reply.png" alt="Replying to User Questions with Saved Annotations" />
</Frame>
...
<Frame>
  <img src="/images/assets/logs-annotation-switch.png" alt="Enabling Annotated Replies in Logs and Annotations" />
</Frame>
...
<Frame>
  <img src="/images/assets/annotated-replies-initial.png" alt="Setting Parameters for Annotated Replies" />
</Frame>
...
<Frame>
  <img src="/images/assets/bulk-import-annotated.png" alt="Bulk Import of Annotated Q&A Pairs" />
</Frame>
...
<Frame>
  <img src="/images/assets/bulk-export-annotations.png" alt="Bulk Export of Annotated Q&A Pairs" />
</Frame>
...
<Frame>
  <img src="/images/assets/view-annotation-hit-history.png" alt="Viewing Annotation Hit History" />
</Frame>