...
<Frame title="混合检索+重排序">
  <img src="user-guide/.gitbook/assets/image (179).png" alt="" />
</Frame>
...
<Frame title="在模型供应商内配置 Cohere Rerank 模型">
  <img src="user-guide/.gitbook/assets/image (163).png" alt="" />
</Frame>
...
<Frame title="数据集检索模式中设置 Rerank 模型">
  <img src="user-guide/.gitbook/assets/image (132).png" alt="" width="563" />
</Frame>
...
<Frame title="数据集多路召回模式中设置 Rerank 模型">
  <img src="user-guide/.gitbook/assets/image (133).png" alt="" />
</Frame>
