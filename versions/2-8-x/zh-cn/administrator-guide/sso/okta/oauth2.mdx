...
<Tabs>
  <Tab title="Workspace">
   点击 Dify 企业版的“身份认证”页，轻点“成员认证”内 SSO 验证页的 **"+ New Identity Provider → New OAuth2 Provider"**，在底部查看 Workspace Callback URL。
  ...
  <Tab title="WebApp（面向内部用户）">
   点击 Dify 企业版的“身份认证”页，轻点“成员认证”内 SSO 验证页的 **"+ New Identity Provider → New OAuth2 Provider"**，在底部查看 Web App Callback URL。
