...
常见情景：构建基于外部数据/知识的 AI 问答系统（RAG）。了解更多关于 RAG 的[基本概念](user-guide/learn-more/extended-reading/retrieval-augment/)。
...
<Frame caption="知识库问答应用示例">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (244).png" alt="知识库问答应用示例" />
</Frame>
...
3. 指定[召回模式](user-guide/learn-more/extended-reading/retrieval-augment/retrieval.md)。自 9 月 1 日后，知识库的召回模式将自动切换为多路召回，不再建议使用 N 选 1 召回模式；
4. 连接并配置下游节点，一般为 LLM 节点；

<Frame caption="知识检索配置">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (74).png" alt="知识检索配置" />
</Frame>

**输出变量**

<Frame caption="输出变量">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (250).png" alt="输出变量" width="272" />
</Frame>
...
<Frame caption="配置下游 LLM 节点">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (77).png" alt="配置下游 LLM 节点" />
</Frame>
