...
<Frame caption="基于 API 扩展">
  <img src="/user-guide/.gitbook/assets/api_based_01.png" alt="基于 API 扩展" />
</Frame>
...
<Frame caption="查看端口">
  <img src="/user-guide/.gitbook/assets/8000.png" alt="查看端口" />
</Frame>
...
<Frame caption="Ngrok 启动">
  <img src="/user-guide/.gitbook/assets/ngrock.png" alt="Ngrok 启动" />
</Frame>
...
详细说明请参考 [使用 Cloudflare Workers 部署 API Tools](/user-guide/tools/extensions/api-based/cloudflare-workers)。
