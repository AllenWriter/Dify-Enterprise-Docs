...
<Frame caption="长故事生成器">
  <img src="../../../.gitbook/assets/iteration-story-generator.png" alt="长故事生成器流程图" />
</Frame>
...
<Frame caption="イテレーションノードの設定" width="375">
  <img src="../../../../img/workflow-iteration-node.png" alt="迭代节点配置界面" />
</Frame>

LLM ノード内で入力変数 `GenerateOverallOutline/output` と `Iteration/item` を設定

<Frame caption="LLMノードの設定" width="375">
  <img src="../../../../img/workflow-iteration-llm-node.png" alt="LLM节点内部配置界面" />
</Frame>
...
<Frame caption="Answerノードの設定" width="375">
  <img src="../../../../img/workflow-configure-anwer-node.png" alt="直接回复节点配置界面" />
</Frame>

6. 完全なデバッグとプレビュー

<Frame caption="ストーリー章ごとの多段イテレーション生成">
  <img src="../../../../img/iteration-node-iteration-through-story-chapters.png" alt="完整调试和预览界面" />
</Frame>

#### **例2：長文イテレーション生成器（別の編成方法）**

<Frame caption="長文イテレーション生成器（別の編成方法）">
  <img src="../../../../img/iteration-node-iteration-long-article-iteration-generator.png" alt="长文章迭代生成器另一种编排方式流程图" />
</Frame>
...
<Frame caption="コードノード出力Array" width="375">
  <img src="../../../../img/workflow-extract-subtitles-and-outlines.png" alt="CODE节点返回数组格式内容界面" />
</Frame>

**パラメータ抽出ノードを使用して返す**

<Frame caption="パラメータ抽出ノード出力array" width="375">
  <img src="../../../../img/workflow-parameter-extraction-node.png" alt="参数提取节点返回数组格式内容界面" />
</Frame>
...
<Frame caption="コードノード変換" width="334">
  <img src="../../../../img/iteration-code-node-convert.png" alt="使用代码节点将数组转换为文本界面" />
</Frame>
...
<Frame caption="テンプレートノード変換" width="332">
  <img src="../../../../img/workflow-template-node.png" alt="使用模板节点将数组转换为文本界面" />
</Frame>
