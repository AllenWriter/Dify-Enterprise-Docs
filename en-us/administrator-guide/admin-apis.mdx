...
- **Workspace Members**: Member management within a specific workspace, including retrieving member information and managing member.
...
- Click the **Postman Collection** download link on the page.

![Postman Collection Download](https://assets-docs.dify.ai/2025/02/5aa925f58ec5bb12a2838704f1444525.png)

- Import the configuration file into Postman.

- Replace the `base_url` and `secret_key` variables in the **Variables**.
