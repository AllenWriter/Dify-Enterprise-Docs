...
![Create a project in Langfuse](../../../images/assets/image (249) (1).png)

Edit a name for the project.

![Create a project in Langfuse](../../../images/assets/image (251) (1).png)

3. Create project API credentials. In the left sidebar of the project, click **Settings** to open the settings.

![Create project API credentials](../../../images/assets/image (253) (1).png)

In Settings, click **Create API Keys** to create project API credentials.

![Create project API credentials](../../../images/assets/image (252) (1).png)

Copy and save the **Secret Key**, **Public Key**, and **Host**.

![Get API Key configuration](../../../images/assets/image (254) (1).png)
...
![Viewing application data in Langfuse](../../../images/assets/view-traces-in-langfuse.png)
