...
![](https://r2.xmsex.net/2024/10/e6c1a1521306919ab325030adafb2d2b.png)
...
1. 先前往 Okta 应用程序的 "Sign On" 页，找到以下信息：
   ...
   * Signing certificate
   ...
   ![](https://r2.xmsex.net/2024/10/edd232ff0c1e0a28243fdce755f8ea1b.png)

2. 接着在 "Assignments" 页分配允许使用 SSO 登录的成员。

   ![](https://r2.xmsex.net/2024/10/7ce55440e9bce1965712e167ab8e8567.png)
...
3. 最后回到 Dify 企业版的 Authentication 页，轻点 **"+ New Identity Provider → New SAML Provider"**，然后在页面中依次填写在上文中获取的信息完成配置。
   ...
   ![](https://r2.xmsex.net/2024/10/1548ea93cfa68352384295fef8b038e3.png)
