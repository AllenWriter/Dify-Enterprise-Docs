...
<Frame caption="変数代入の例" width="375">
  <img src="../../../.gitbook/assets/variable-assigner.png" alt="変数代入の例" />
</Frame>
...
<Frame caption="会話から情報を自動的に判断、抽出、保存します">
  <img src="../../../../img/conversational-variables-scenario-01.png" alt="会話から情報を自動的に判断、抽出、保存のフローチャート" />
</Frame>
...
<Frame caption="ユーザーの初期設定情報を記録する">
  <img src="../../../../img/conversation-var-scenario-1.png" alt="ユーザーの初期嗜好情報を記録するフローチャート" />
</Frame>
...
<Frame caption="Checklistのチェックを補助">
  <img src="../../../../img/conversation-var-scenario-2-1.png" alt="Checklistのチェックを補助のフローチャート" />
</Frame>
...
<Frame caption="変数代入ノードの設定">
  <img src="../../../../img/language-variable-assigner.png" width="375px" alt="変数代入ノードの設定画面" />
</Frame>
