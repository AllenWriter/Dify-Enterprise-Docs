...
<Frame caption="会话变量示例" width="375">
  <img src="/user-guide/.gitbook/assets/zh-conversation-variable.png" alt="会话变量示例图" />
</Frame>
...
<Frame caption="自动判断提取并存储对话中的信息">
  <img src="/user-guide/.gitbook/assets/中文.jpeg" alt="自动判断提取并存储对话中的信息流程图" />
</Frame>
...
<Frame caption="记录用户的初始偏好信息">
  <img src="/user-guide/.gitbook/assets/zh-conversation-var-scenario-1.png" alt="记录用户的初始偏好信息流程图" />
</Frame>
...
<Frame caption="辅助 Checklist 检查">
  <img src="/user-guide/.gitbook/assets/conversation-var-scenario-2-1.png" alt="辅助 Checklist 检查流程图" />
</Frame>
...
<Frame caption="变量赋值节点设置" width="375">
  <img src="/user-guide/.gitbook/assets/zh-language-variable-assigner.png" alt="变量赋值节点设置界面" />
</Frame>
