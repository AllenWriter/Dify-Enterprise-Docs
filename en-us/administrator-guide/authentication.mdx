...
<div style={{ display: 'flex', gap: '20px' }}>
  <Frame>
    <img src="/en-us/img/auth-3.png" alt="First image description" />
  </Frame>
  <Frame>
    <img src="/en-us/img/auth-4.png" alt="Second image description" />
  </Frame>
</div>
...
<div style={{ display: 'flex', gap: '20px' }}>
  <Frame>
    <img src="/en-us/img/auth-5.png" alt="First image description" />
  </Frame>
  <Frame>
    <img src="/en-us/img/auth-6.png" alt="Second image description" />
  </Frame>
</div>
