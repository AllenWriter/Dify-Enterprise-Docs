...
![](../https://filesimages.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRncMhlfeYTrpujwzDIqw%2Fuploads%2FQ2CvvgqQXmsUMXZR4u8N%2Fimage.png?alt=media&#x26;token=f7273557-94f7-4250-adfe-8d2e11f6a307)Configuring Firecrawl Credentials
...
[Get the API Key and save it in Dify](https://filesimages.com/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FRncMhlfeYTrpujwzDIqw%2Fuploads%2FtAwcLoAYT1A2v12pfJC3%2Fimage.png?alt=media&#x26;token=3b5b784f-2808-431f-8595-2638d038c190)
...
![Web scraping configuration](../../../images/assets/image (102).png)
...
![Execute scraping](../../../images/assets/image (103).png)
...
![Importing parsed web text into the knowledge base](../../../images/assets/image (104).png)
...
![Web Crawling Configuration](../../../images/assets/image (107).png)
...
![Executing the Crawl](../../../images/assets/image (109).png)
...
![Importing parsed web text into the knowledge base](../../../images/assets/image (110).png)
