...
<Frame caption="AWS CDK infra">
  <img src="/en-us/img/aws-cdk-1.png" alt="AWS CDK infra" />
</Frame>
...
7. ### Update AWS EKS Access Permissions:
   ...
   1. Navigate to the EKS Cluster panel, select the "Access" menu, and click on "Manage access":
    ...
    <Frame caption="AWS CDK infra">
      <img src="/en-us/img/aws-cdk-2.png" alt="AWS CDK infra" />
    </Frame>
   ...
   3. In the IAM Access Entries panel, click "Create access entry":
    ...
    <Frame caption="IAM access entries">
      <img src="/en-us/img/aws-cdk-3.png" alt="IAM access entries" />
    </Frame>
...
To customize deployment configurations, modify the <a href="/assets/configs/test.ts" download="test.ts" target="_blank" rel="noopener noreferrer">test.ts</a> file for the testing environment or the <a href="/assets/configs/prod.ts" download="prod.ts" target="_blank" rel="noopener noreferrer">prod.ts</a> file for the production environment.
