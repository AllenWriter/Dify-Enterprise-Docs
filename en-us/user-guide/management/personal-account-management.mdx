...
|-----------|------------------------------------------------------------------------------|
| Community | Email and password                                                           |
| Cloud     | GitHub account authorization, Google account authorization, email and verification code |
...
![Delete personal account](../../.gitbook/assets/image (2).png)
