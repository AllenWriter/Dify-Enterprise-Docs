...
⚠️ Warning: Dangerous Operation – Proceed with Caution

Click the menu button next to a member and select **Delete** to remove them. Once deleted, the member will no longer be able to log in to the Dify platform.
