...
![Model Load Balancing](/images/assets/load-balancing.png)
...
![Configuring Load Balancing](/images/assets/load-balancing-1.png)
...
![](/images/assets/load-balancing-2.png)

Once configured, all models with load balancing enabled will be displayed in the model list.

![Enabling Load Balancing](/images/assets/load-balancing-3.png)
...
![Configuring Load Balancing from Add Model](/images/assets/load-balancing-4.png)