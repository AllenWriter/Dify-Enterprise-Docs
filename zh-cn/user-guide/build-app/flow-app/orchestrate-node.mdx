...
<Frame caption="上图为串行节点流、下图为并行节点流">
  <img src="/user-guide/.gitbook/assets/image (336).png" alt="串行和并行节点流对比图" />
</Frame>
...
<Frame caption="串行结构">
  <img src="/user-guide/.gitbook/assets/image (337).png" alt="串行结构设计示意图" />
</Frame>
...
<Frame caption="串行结构应用日志">
  <img src="/user-guide/.gitbook/assets/image (339).png" alt="串行结构应用日志界面" />
</Frame>
...
<Frame caption="并行设计">
  <img src="/user-guide/.gitbook/assets/image (335).png" alt="并行设计示意图" />
</Frame>
...
<Frame caption="Type 01">
  <img src="/user-guide/.gitbook/assets/image (340).png" alt="新建并行结构方式1" />
</Frame>
...
<Frame caption="Type 02">
  <img src="/user-guide/.gitbook/assets/image (341).png" alt="新建并行结构方式2" />
</Frame>
...
<Frame caption="Type 03">
  <img src="/user-guide/.gitbook/assets/image (342).png" alt="新建并行结构方式3" />
</Frame>
...
<Frame caption="Type 04">
  <img src="/user-guide/.gitbook/assets/image (343).png" alt="新建并行结构方式4" />
</Frame>
...
<Frame caption="Chatflow 应用中的并行结构">
  <img src="/user-guide/.gitbook/assets/image (344).png" alt="Chatflow 应用中的并行结构示例" />
</Frame>
...
<Frame caption="普通并行">
  <img src="/user-guide/.gitbook/assets/image (345).png" alt="普通并行结构示例" />
</Frame>
...
<Frame caption="嵌套并行：2 层嵌套关系">
  <img src="/user-guide/.gitbook/assets/image (349).png" alt="嵌套并行结构示例" />
</Frame>
...
<Frame caption="条件分支 + 并行">
  <img src="/user-guide/.gitbook/assets/image (333).png" alt="条件分支和并行结构结合示例" />
</Frame>
...
<Frame caption="迭代分支+并行">
  <img src="/user-guide/.gitbook/assets/image (350).png" alt="迭代分支和并行结构结合示例" />
</Frame>
...
<Frame caption="并行结构" width="315">
  <img src="/user-guide/.gitbook/assets/image (351).png" alt="并行结构应用日志界面" />
</Frame>