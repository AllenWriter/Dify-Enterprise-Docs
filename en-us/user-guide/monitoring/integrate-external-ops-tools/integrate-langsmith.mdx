...
<Frame>
  <img src="/images/assets/image (3) (1) (1) (1).png" alt="Create a project in LangSmith" />
</Frame>

Once created, you can view all created projects in the Projects section.

<Frame>
  <img src="/images/assets/image (7) (1) (2).png" alt="View created projects in LangSmith" />
</Frame>
...
<Frame>
  <img src="/images/assets/image (8) (1) (2).png" alt="Project settings" />
</Frame>

Click **Create API Key** to create project credentials.

<Frame>
  <img src="/images/assets/image (3) (1) (1) (1) (2).png" alt="Create a project API Key" />
</Frame>

Select **Personal Access Token** for subsequent API authentication.

<Frame>
  <img src="/images/assets/image (5) (1) (1) (1).png" alt="Create an API Key" />
</Frame>

Copy and save the created API key.

<Frame>
  <img src="/images/assets/image (9) (2).png" alt="Copy API Key" />
</Frame>
...
<Frame>
  <img src="/images/assets/tracing-app-performance.png" alt="Tracing app performance" />
</Frame>

After clicking configure, paste the **API Key** and **project name** created in LangSmith into the configuration and save.

<Frame>
  <img src="/images/assets/config-langsmith.png" alt="Configure LangSmith" />
</Frame>
...
<Frame>
  <img src="/images/assets/integrate-with-langsmith.png" alt="View configuration status" />
</Frame>
...
<Frame>
  <img src="/images/assets/debug-app-in-dify.png" alt="Debugging Applications in Dify" />
</Frame>

When you switch to LangSmith, you can view detailed operation logs of Dify applications in the dashboard.

<Frame>
  <img src="/images/assets/image (2) (1) (1) (1).png" alt="Viewing application data in LangSmith" />
</Frame>

Detailed LLM operation logs through LangSmith will help you optimize the performance of your Dify application.

<Frame>
  <img src="/images/assets/viewing-app-data-in-langsmith.png" alt="Viewing application data in LangSmith" />
</Frame>
