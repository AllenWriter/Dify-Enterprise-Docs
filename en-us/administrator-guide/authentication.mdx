...
System administrators can flexibly set authentication methods for workspaces and the enterprise admin panel based on business requirements, to uniformly manage authentication methods for enterprise members.
...
<div style={{ display: 'flex', gap: '20px' }}>
  <Frame caption="Enterprise Admin Panel Authentication Settings — Email and Password">
...
<div style={{ display: 'flex', gap: '20px' }}>
  <Frame caption="Enterprise Admin Panel Authentication Settings — Email and Verification Code">
...
<div style={{ display: 'flex', gap: '20px' }}>
  <Frame caption="Enterprise Admin Panel Authentication Settings — Single Sign-On (SSO)">
